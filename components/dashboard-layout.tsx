...
import { Home, CreditCard, History, Settings, Users, LogOut, BarChart3, FileText, UserCog } from "lucide-react"
  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen bg-gray-50">
        {/* Make sidebar permanent by removing collapsible property */}
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-blue-900">
                ...
                {pathname === `/${userType}/administrateurs` && "Gestion des administrateurs"}
                {pathname === `/${userType}/rapports` && "Rapports"}
              </h1>
              <p className="text-muted-foreground">
                ...
                {pathname === `/${userType}/administrateurs` && "Gérez les comptes administrateurs"}
                {pathname === `/${userType}/rapports` && "Consultez les rapports financiers"}
              </p>
            </div>
